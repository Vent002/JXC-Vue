<template>
  <div v-loading='loading'>
    <div class="main" v-title data-title="库存统计"></div>
    <div class="inventories-body">
      ...
      <div class="inventories-contant">
        <div class="graph">
          <div style="float:left" class='inventorisCharts' ref='chart'></div>
        ...
        <el-card class="inventories-table">
          ...
          <el-table
            ...
            <el-table-column
              ...
              fit>
              <template slot-scope="scope">
                <span style="margin-left: 10px" v-if='scope.row.goodsInventory >= 10'>{{ scope.row.goodsTypeInfo.goodsTypeName }}</span>
                <el-badge value="请登记" class="item" v-else-if='scope.row.goodsTypeInfo.goodsTypeName === null'>
                  <span style="margin-left: 10px" >
                    {{scope.row.goodsTypeInfo.goodsTypeName}}
                  </span>
                </el-badge>
                <el-badge value="hot" class="item" v-else>
            ...
            <el-table-column
              ...
              fit>
              <template slot-scope="scope">
                <span style="margin-left: 10px" v-if='scope.row.goodsInventory >= 10'>{{ scope.row.goodsInventory }}</span>
                <span style="margin-left: 10px;color:red;font-size:18px" v-else>{{ scope.row.goodsInventory }}</span>
              </template>
            </el-table-column>
