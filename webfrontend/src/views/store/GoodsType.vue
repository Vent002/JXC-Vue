          ...
          <el-dialog class="dialog"
            ...
            <el-form v-model="editGoods"
              ...
              <el-form-item label="商品种类"
                            prop="goodsTypeNum">
                <el-input type="text"
                          v-model="editGoods.goodsTypeNum"
                          auto-complete="off"
                          disabled></el-input>
              </el-form-item>
              <el-form-item label="商品名称"
                            prop="goodsTypeName">
                <el-input type="text"
                          v-model="editGoods.goodsTypeName"
                          disabled></el-input>
              </el-form-item>
              <el-form-item label="日期"
                            prop="createDate">
                <div class="block">
                  <el-date-picker v-model="editGoods.createDate"
                                  type="datetime"
                                  class="input-class"
                                  disabled
                                  placeholder="选择日期时间">
            ...
            <div slot="footer"
              ...
              <el-button type="primary"
                         @click="editSubmit(editGoods.id,editGoods.goodsPrice)">提交</el-button>
            </div>
          </el-dialog>
          <!-- 添加商品种类对话框 -->
          <el-dialog class="dialog"
            ...
            <el-form v-model="formGoods"
                     :rules="formGoodsRules"
                     ref="formGoods">
              <el-form-item label="类型"
                            :label-width="formLabelWidth"
                            prop="goodsNum">
                <el-input v-model="formGoods.goodsNum"
                          autocomplete="off"
                          placeholder="eg:1001"
                          clearable></el-input>
              </el-form-item>
              <el-form-item label="商品名称"
                            :label-width="formLabelWidth"
                            prop="goodsName">
                <el-input v-model="formGoods.goodsName"
                          placeholder="eg:月明"
                          clearable>
                </el-input>
              </el-form-item>
              <el-form-item label="日期"
                ...
                <el-date-picker v-model="formGoods.goodsCreateDate"
                                clearable
                                align="right"
                                type="datetime"
                                class="input-class"
            ...
            <div slot="footer"
              ...
              <el-button type="primary"
                         @click.native="addGoodsInfo">确 定</el-button>
            </div>
          </el-dialog>
...
export default {
  ...
  methods: {
    ...
    editSubmit(id, editGoodsPrice) {
      updateGoodsTypeInfo(id, editGoodsPrice)
        .then(res => {
          if (res.code === 200) {
            this.editFormVisible = false
            this.$message({
